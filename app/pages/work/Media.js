...
export default class Media extends Group {
  ...
  hoverCreate () {
    this.hoverGeometry = new PlaneGeometry(this.width, this.height, 1, 1)
  ...
  mediaCreate () {
    this.mediaGeometry = new PlaneGeometry(this.width, this.height, 100, 100)
  ...
  overlayCreate () {
    this.overlayGeometry = new PlaneGeometry(this.width, this.height, 100, 100)
  ...
  titleCreate () {
    ...
    this.titleGeometry = new PlaneGeometry(canvasTrimmed.width / 8, canvasTrimmed.height / 8, 100, 100)
